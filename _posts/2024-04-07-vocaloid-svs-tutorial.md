...
summary: 
excerpt_image: /assets/images/vocaloid-svs-tutorial/27.png
top: 1
---
...
![](/assets/images/vocaloid-svs-tutorial/3.png) ![](/assets/images/vocaloid-svs-tutorial/4.png)
...
![](/assets/images/vocaloid-svs-tutorial/11.png) ![](/assets/images/vocaloid-svs-tutorial/12.png) ![](/assets/images/vocaloid-svs-tutorial/13.png)

创建声库后，检查`ViewDB -> stationary`是否正常。下图显示它应该是什么样子。  
![](/assets/images/vocaloid-svs-tutorial/14.png)
...
![](/assets/images/vocaloid-svs-tutorial/16.png) ![](/assets/images/vocaloid-svs-tutorial/17.png)
...
下图为分段查看/编辑窗口。
![](/assets/images/vocaloid-svs-tutorial/19.png)
...
![1条转录](/assets/images/vocaloid-svs-tutorial/26.png)
![6条转录](/assets/images/vocaloid-svs-tutorial/27.png)
...
![单C（包含所有鼻音和呼吸音）](/assets/images/vocaloid-svs-tutorial/28.png)
![V+VV（包含N\\，不包含其他鼻音）](/assets/images/vocaloid-svs-tutorial/29.png)
![CVVC](/assets/images/vocaloid-svs-tutorial/30.png)
![VCV+CVVC](/assets/images/vocaloid-svs-tutorial/31.png)
![CCV+VCSil](/assets/images/vocaloid-svs-tutorial/32.png)
...
![](/assets/images/vocaloid-svs-tutorial/40.png)  
...
![](/assets/images/vocaloid-svs-tutorial/41.png)
...
![](/assets/images/vocaloid-svs-tutorial/42.png)
...
![](/assets/images/vocaloid-svs-tutorial/43.png)

返回 DBTool；确保声库已加载，然后单击 `SYNTHESIS_WORKSPACE`。
![](/assets/images/vocaloid-svs-tutorial/44.png)

加载音频文件。（`.msd` 文件将自动加载。）
![](/assets/images/vocaloid-svs-tutorial/45.png)

现在您可以直接查看声库内部发生的情况了。
![](/assets/images/vocaloid-svs-tutorial/46.png)
...
![](/assets/images/vocaloid-svs-tutorial/47.png)
...
![](/assets/images/vocaloid-svs-tutorial/50.png)
...
![](/assets/images/vocaloid-svs-tutorial/51.png)
![](/assets/images/vocaloid-svs-tutorial/52.png)

使用`当前歌手属性`，您可以设置默认歌手、创建 XSY 预设等等。   
![](/assets/images/vocaloid-svs-tutorial/53.png)

将声库导入 Vocaloid5/6 编辑器非常简单，只需以管理员身份运行通过 VVD Editor Plus 生成的 `.bat` 安装程序，运行一次 Vocareg 即可（这是针对 FE 库的情况，而“正版”数据库的工作流程则大不相同）。  
![](/assets/images/vocaloid-svs-tutorial/54.png)

这样声库也会出现在 Tunelab 中，使其完全可用。  
![](/assets/images/vocaloid-svs-tutorial/55.png)
...
![](/assets/images/vocaloid-svs-tutorial/56.png)  
<u>**务必记住要保持设置 bmp 的正确尺寸！**</u>  
![](/assets/images/vocaloid-svs-tutorial/57.png) 
...
![](/assets/images/vocaloid-svs-tutorial/58.png)